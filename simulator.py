...
ALL_QUESTIONS = [
    {
        ...
        "options": [
            "To enable change in an enterprise by defining needs and recommending solutions that deliver value to stakeholders",
            "To manage project timelines and deliverables",
            "To design technical architectures for software systems",
            "To audit business processes for regulatory compliance"
        ],
        "answer": "To enable change in an enterprise by defining needs and recommending solutions that deliver value to stakeholders",
    ...
    },
    {
        ...
        "options": [
            ...
            "Change in an enterprise through needs definition and value-delivering solutions",
            "Reduction of project management overhead",
            "Elimination of stakeholder conflicts"
        ],
        "answer": "Change in an enterprise through needs definition and value-delivering solutions",
    ...
    },
    {
        ...
        "options": [
            ...
            "Identifying the real need before committing to a solution"
        ],
        "answer": "Identifying the real need before committing to a solution",
    ...
    },
    {
        ...
        "options": [
            ...
            "Insufficient business analysis—the right problems are not being defined before solutions are built",
            "Weak change management"
        ],
        "answer": "Insufficient business analysis—the right problems are not being defined before solutions are built",
    ...
    },
    {
        ...
        "options": [
            ...
            "Understanding the true need rather than accepting the assumed solution"
        ],
        "answer": "Understanding the true need rather than accepting the assumed solution",
    ...
    },
    {
        ...
        "options": [
            "BA focuses on managing scope; PM focuses on managing requirements",
            "BA identifies needs and recommends value-delivering solutions; PM manages delivery within constraints of time, cost, and scope",
            "BA is performed only at project initiation; PM spans the entire project",
            "BA and PM are interchangeable in agile contexts"
        ],
        "answer": "BA identifies needs and recommends value-delivering solutions; PM manages delivery within constraints of time, cost, and scope",
    ...
    },
    {
        ...
        "options": [
            "It is only applicable in organizations with a formal BA department",
            "It must be certified before being applied",
            "It requires a specific software toolset",
            "It is a professional discipline with defined competencies that can be applied in any organizational context"
        ],
        "answer": "It is a professional discipline with defined competencies that can be applied in any organizational context",
    ...
    },
    {
        ...
        "options": [
            "The risk of building correct solutions to the wrong problem due to skipping BA",
            "Poor development quality",
            "Inadequate testing coverage",
            "Weak project governance"
        ],
        "answer": "The risk of building correct solutions to the wrong problem due to skipping BA",
    ...
    },
    {
        ...
        "options": [
            "BA reduces development costs by writing detailed specifications",
            "BA provides audit-ready documentation",
            "BA prevents scope creep",
            "BA ensures investment in change is directed at the right problems and solutions, maximizing business value realization"
        ],
        "answer": "BA ensures investment in change is directed at the right problems and solutions, maximizing business value realization",
    ...
    },
    {
        ...
        "options": [
            "Only IT and software development projects",
            "Any initiative where change is being considered, regardless of industry, domain, or methodology",
            "Only large enterprises with formal BA departments",
            "Only projects with a dedicated BA resource"
        ],
        "answer": "Any initiative where change is being considered, regardless of industry, domain, or methodology",
    ...
    },
    {
        ...
        "options": [
            "BA only applies to technology projects",
            "The BA will manage the project",
            "BA adds value whenever organizational change is being considered, including purely process-focused initiatives",
            "BA is required for all non-profit initiatives by regulation"
        ],
        "answer": "BA adds value whenever organizational change is being considered, including purely process-focused initiatives",
    ...
    },
    {
        ...
        "options": [
            "BA executes the strategy by managing projects",
            "BA has no role in strategic matters",
            "BA replaces strategic planning",
            "BA bridges the gap between organizational strategy and tactical execution by ensuring the right needs are identified and addressed"
        ],
        "answer": "BA bridges the gap between organizational strategy and tactical execution by ensuring the right needs are identified and addressed",
    ...
    },
    {
        ...
        "options": [
            "Only individuals with 'Business Analyst' in their job title",
            "Only CBAP®-certified professionals",
            "Only employees of the business, not IT or vendors",
            "Any individual who performs the tasks described in the BABOK® Guide, regardless of job title"
        ],
        "answer": "Any individual who performs the tasks described in the BABOK® Guide, regardless of job title",
    ...
    },
    {
        ...
        "options": [
            "Only dedicated Business Analysts",
            "Only senior management",
            "Only IT professionals",
            "Product Owner, Project Manager, Subject Matter Expert, Consultant, or anyone performing BA tasks"
        ],
        "answer": "Product Owner, Project Manager, Subject Matter Expert, Consultant, or anyone performing BA tasks",
    ...
    },
    {
        ...
        "options": [
            "Is not performing BA because they lack a BA title",
            "Is performing business analysis tasks",
            "Needs CBAP® certification to legitimately perform these activities",
            "Is performing project management, not business analysis"
        ],
        "answer": "Is performing business analysis tasks",
    ...
    },
    {
        ...
        "options": [
            "BA tasks may be distributed, but what matters is whether all BA tasks are being performed with sufficient rigor and quality",
            "Agree—developers can fully replace BA",
            "Disagree—only certified BAs can perform BA tasks",
            "Defer to the agile coach's decision"
        ],
        "answer": "BA tasks may be distributed, but what matters is whether all BA tasks are being performed with sufficient rigor and quality",
    ...
    },
    {
        ...
        "options": [
            "Performing IT work unrelated to BA",
            "Only performing design work",
            "Performing project management tasks",
            "Performing business analysis tasks within an IT context"
        ],
        "answer": "Performing business analysis tasks within an IT context",
    ...
    },
    {
        ...
        "options": [
            ...
            "Solutions may not address actual business needs, wasting investment and reducing value delivery",
            "Stakeholders will always be unhappy",
            "Projects will always exceed budget"
        ],
        "answer": "Solutions may not address actual business needs, wasting investment and reducing value delivery",
    ...
    },
    {
        ...
        "options": [
            "Not a BA because they work for a consulting firm",
            "A BA for the purposes of that engagement",
            "A project manager performing BA tasks incorrectly",
            "Not qualified without CBAP® certification"
        ],
        "answer": "A BA for the purposes of that engagement",
    ...
    },
    {
        ...
        "answer": "Business Analysis Planning and Monitoring",
    ...
    },
    {
        ...
        "answer": "Elicitation and Collaboration",
    ...
    },
    {
        ...
        "answer": "Requirements Life Cycle Management",
    ...
    },
    {
        ...
        "answer": "Requirements Analysis and Design Definition",
    ...
    },
    {
        ...
        "options": [
            "Inappropriate—Knowledge Areas must be executed sequentially",
            "Only possible with multiple BA resources",
            "Only acceptable in agile projects",
            "Appropriate—Knowledge Areas can be performed in any order, iteratively, and in parallel"
        ],
        "answer": "Appropriate—Knowledge Areas can be performed in any order, iteratively, and in parallel",
    ...
    },
    {
        ...
        "options": [
            "Agree—BABOK® v3 was written for waterfall",
            "Defer to the scrum master's judgment",
            "Partially agree—only RADD and RLCM apply to agile",
            "Disagree—Knowledge Areas describe BA work that applies across all methodologies; execution is tailored, not applicability"
        ],
        "answer": "Disagree—Knowledge Areas describe BA work that applies across all methodologies; execution is tailored, not applicability",
    ...
    },
    {
        ...
        "options": [
            "Only RLCM",
            "Only Elicitation and Collaboration",
            "Strategy Analysis (redefine future state), RLCM (update requirements), and RADD (revise designs)",
            "Only Solution Evaluation"
        ],
        "answer": "Strategy Analysis (redefine future state), RLCM (update requirements), and RADD (revise designs)",
    ...
    },
    {
        ...
        "options": [
            "They form a sequential process that must be followed from start to finish",
            "They are interrelated groups of tasks that collectively represent the scope of BA work",
            "They are independent and can each be applied without reference to the others",
            "They are mutually exclusive—work done in one cannot relate to another"
        ],
        "answer": "They are interrelated groups of tasks that collectively represent the scope of BA work",
    ...
    },
    {
        ...
        "options": [
            "Stakeholder, Requirement, Change, Risk, Value, Benefit",
            "Change, Requirement, Design, Risk, Stakeholder, Context",
            "Need, Solution, Value, Risk, Change, Constraint",
            "Change, Need, Solution, Stakeholder, Value, Context"
        ],
        "answer": "Change, Need, Solution, Stakeholder, Value, Context",
    ...
    },
    {
        ...
        "options": [
            "A modification to project scope",
            "The act of transformation in response to a need",
            "A new IT system",
            "Any deviation from the project plan"
        ],
        "answer": "The act of transformation in response to a need",
    ...
    },
    {
        ...
        "options": [
            "A stakeholder request or wish",
            "A business rule or constraint",
            "A documented requirement",
            "A problem or opportunity to be addressed"
        ],
        "answer": "A problem or opportunity to be addressed",
    ...
    },
    {
        ...
        "answer": "A specific way of satisfying one or more needs in a context",
    ...
    },
    {
        ...
        "options": [
            ...
            "Only those who directly use the solution",
            "Only internal employees"
        ],
        "answer": "A group or individual with a relationship to the change, the need, or the solution",
    ...
    },
    {
        ...
        "options": [
            ...
            "The number of requirements satisfied",
            "The worth, importance, or usefulness of something to a stakeholder within a context",
            "Technical quality of the solution"
        ],
        "answer": "The worth, importance, or usefulness of something to a stakeholder within a context",
    ...
    },
    {
        ...
        "answer": "The circumstances that influence, are influenced by, and provide understanding of the change",
    ...
    },
    {
        ...
        "options": [
            "Each concept can be analyzed in isolation",
            "Only three concepts apply to any given initiative",
            "The concepts must be analyzed in a fixed order",
            "Understanding any one concept requires considering its relationships to the other five"
        ],
        "answer": "Understanding any one concept requires considering its relationships to the other five",
    ...
    },
    {
        ...
        "options": [
            "The Need was not properly defined",
            "Value is stakeholder-specific—different stakeholders perceive the value of the same change differently",
            "The Solution does not meet requirements",
            "The Context changed during execution"
        ],
        "answer": "Value is stakeholder-specific—different stakeholders perceive the value of the same change differently",
    ...
    },
    {
        ...
        "options": [
            "A process model for executing BA tasks",
            "A replacement for the Knowledge Areas",
            "A universal conceptual framework providing shared vocabulary applicable to all BA work",
            "Only used during the planning phase"
        ],
        "answer": "A universal conceptual framework providing shared vocabulary applicable to all BA work",
    ...
    },
    {
        ...
        "options": [
            "Need–Stakeholder misalignment",
            "Value–Stakeholder misalignment",
            "Solution–Context conflict—the solution is not viable within its regulatory context",
            "Change–Need misalignment"
        ],
        "answer": "Solution–Context conflict—the solution is not viable within its regulatory context",
    ...
    },
    {
        ...
        "options": [
            "Every BA task relates to at least one BACCM concept, and the concepts are interrelated—isolating any one leads to incomplete understanding",
            "Requirements must always be traceable to test cases",
            "Requirements are only written by BAs",
            "Requirements define the solution architecture"
        ],
        "answer": "Every BA task relates to at least one BACCM concept, and the concepts are interrelated—isolating any one leads to incomplete understanding",
    ...
    },
    {
        ...
        "options": [
            "A formally documented Solution",
            "A Stakeholder register",
            "A shared understanding of Value—what worth or benefit the change is expected to deliver to stakeholders",
            "A defined Change management process"
        ],
        "answer": "A shared understanding of Value—what worth or benefit the change is expected to deliver to stakeholders",
    ...
    },
    {
        ...
        "options": [
            ...
            "Explicit, Implicit, Derived, Assumed",
            "Current-state, Future-state, Gap, Design"
        ],
        "answer": "Business, Stakeholder, Solution, Transition",
    ...
    },
    {
        ...
        "options": [
            "The high-level goals and objectives of the organization",
            "What each stakeholder needs from the solution",
            "How the system must be built technically",
            "Temporary needs for the cutover period"
        ],
        "answer": "The high-level goals and objectives of the organization",
    ...
    },
    {
        ...
        "options": [
            ...
            "The needs of a specific stakeholder or stakeholder class",
            "Temporary cutover needs"
        ],
        "answer": "The needs of a specific stakeholder or stakeholder class",
    ...
    },
    {
        ...
        "options": [
            "System performance and quality attributes",
            "Strategic business objectives",
            "Temporary cutover needs",
            "The behaviors and capabilities the solution must have"
        ],
        "answer": "The behaviors and capabilities the solution must have",
    ...
    },
    {
        ...
        "options": [
            ...
            "Quality attributes, constraints, and conditions—such as performance, security, and usability",
            "Temporary cutover requirements",
            "Business objectives"
        ],
        "answer": "Quality attributes, constraints, and conditions—such as performance, security, and usability",
    ...
    },
    {
        ...
        "options": [
            "Permanent capabilities the solution must have after go-live",
            "Stakeholder expectations for the end system",
            "Capabilities needed only to move from the current state to the future state",
            "High-level business objectives"
        ],
        "answer": "Capabilities needed only to move from the current state to the future state",
    ...
    },
    {
        ...
        "answer": "Stakeholder requirement",
    ...
    },
    {
        ...
        "answer": "Functional solution requirement",
    ...
    },
    {
        ...
        "answer": "Non-functional solution requirement",
    ...
    },
    {
        ...
        "options": [
            ...
            "Stakeholder, Business, Functional, Transition",
            "Business, Functional, Non-functional, Transition",
            "Business, Stakeholder, Non-functional, Transition"
        ],
        "answer": "Business, Stakeholder, Non-functional, Transition",
    ...
    },
    {
        ...
        "options": [
            "Yes—it becomes a permanent non-functional requirement",
            "No—it becomes a stakeholder requirement",
            "Yes—it becomes a business requirement",
            "No—transition requirements are temporary and retired once the transition is complete"
        ],
        "answer": "No—transition requirements are temporary and retired once the transition is complete",
    ...
    },
    {
        ...
        "options": [
            "Non-functional requirements that don't require traceability",
            "Transition requirements that were missed",
            "Scope creep or orphaned requirements that should be assessed for validity",
            "Design constraints added by the architecture team"
        ],
        "answer": "Scope creep or orphaned requirements that should be assessed for validity",
    ...
    },
    {
        ...
        "options": [
            ...
            "Business requirements are derived from stakeholder requirements",
            "Stakeholder requirements must support and trace back to business requirements",
            "They are independent and need no alignment"
        ],
        "answer": "Stakeholder requirements must support and trace back to business requirements",
    ...
    },
    {
        ...
        "options": [
            "Agree—functional requirements are sufficient",
            "Partially agree—only security requirements need to be explicit",
            "Disagree—non-functional requirements define quality attributes that cannot be inferred from functional behaviors and are essential to solution success",
            "Defer to the architect's judgment"
        ],
        "answer": "Disagree—non-functional requirements define quality attributes that cannot be inferred from functional behaviors and are essential to solution success",
    ...
    },
    {
        ...
        "options": [
            "The project sponsor",
            "Only internal employees",
            "Only direct users of the solution",
            "A group or individual with a relationship to the change, the need, or the solution"
        ],
        "answer": "A group or individual with a relationship to the change, the need, or the solution",
    ...
    },
    {
        ...
        "options": [
            "Only customers and end users",
            "Only senior management",
            "Sponsor, Customer, End User, Domain SME, Regulator, Supplier, Tester, Operational Support, BA, and PM",
            "Only the project team"
        ],
        "answer": "Sponsor, Customer, End User, Domain SME, Regulator, Supplier, Tester, Operational Support, BA, and PM",
    ...
    },
    {
        ...
        "options": [
            "No—only direct users are stakeholders",
            "Yes—they have a relationship to the change and its outputs",
            "No—external parties are not stakeholders",
            "Yes—only if they attend project meetings"
        ],
        "answer": "Yes—they have a relationship to the change and its outputs",
    ...
    },
    {
        ...
        "answer": "Domain Subject Matter Expert",
    ...
    },
    {
        ...
        "options": [
            "Incomplete stakeholder identification leading to missed requirements and late-stage rework",
            "Poor requirements documentation",
            "Inadequate testing",
            "Poor project governance"
        ],
        "answer": "Incomplete stakeholder identification leading to missed requirements and late-stage rework",
    ...
    },
    {
        ...
        "options": [
            "The BA should not document their own concerns",
            "The BA has a relationship to the change and its outcomes and should be recognized in stakeholder analysis",
            "The BA manages all other stakeholders",
            "The BA's requirements take priority"
        ],
        "answer": "The BA has a relationship to the change and its outcomes and should be recognized in stakeholder analysis",
    ...
    },
    {
        ...
        "options": [
            "The requirements classification",
            "The project risk register",
            "The solution design",
            "The stakeholder engagement strategy"
        ],
        "answer": "The stakeholder engagement strategy",
    ...
    },
    {
        ...
        "options": [
            "Prioritize the more senior group's needs automatically",
            "Document both and let developers decide",
            "Facilitate resolution by understanding both perspectives, assessing business value, and escalating to the sponsor if needed",
            "Remove one group from the stakeholder register"
        ],
        "answer": "Facilitate resolution by understanding both perspectives, assessing business value, and escalating to the sponsor if needed",
    ...
    },
    {
        ...
        "options": [
            "Requirements describe what is needed; designs describe how the solution will satisfy the need",
            "Requirements are written by BAs; designs are created by architects",
            "Requirements are high-level; designs are detailed",
            "Requirements are for business; designs are for IT"
        ],
        "answer": "Requirements describe what is needed; designs describe how the solution will satisfy the need",
    ...
    },
    {
        ...
        "answer": "A requirements artifact",
    ...
    },
    {
        ...
        "options": [
            "A business requirement",
            "A design artifact describing data structure",
            "A stakeholder requirement",
            "A non-functional requirement"
        ],
        "answer": "A design artifact describing data structure",
    ...
    },
    {
        ...
        "options": [
            "The same artifact can serve as both a requirement and a design depending on abstraction level and audience",
            "Requirements and designs are always mutually exclusive",
            "Only textual artifacts qualify as requirements",
            "Designs are always created after requirements are finalized"
        ],
        "answer": "The same artifact can serve as both a requirement and a design depending on abstraction level and audience",
    ...
    },
    {
        ...
        "options": [
            "No risk—requirements and designs are the same",
            "The risk of scope creep",
            "Requirements (what is needed) may be confused with design (how to build it), unnecessarily constraining the solution space",
            "The risk of missing stakeholder sign-off"
        ],
        "answer": "Requirements (what is needed) may be confused with design (how to build it), unnecessarily constraining the solution space",
    ...
    },
    {
        ...
        "options": [
            "Pure stakeholder requirements",
            "Design constraints embedded within acceptance criteria",
            "Transition requirements",
            "Non-functional requirements"
        ],
        "answer": "Design constraints embedded within acceptance criteria",
    ...
    },
    {
        ...
        "options": [
            "Only architects should produce designs",
            "The distinction helps the BA know when they are defining what is needed versus how it will be delivered, avoiding premature solution commitment",
            "Requirements are always more important than designs",
            "The distinction is only relevant in waterfall projects"
        ],
        "answer": "The distinction helps the BA know when they are defining what is needed versus how it will be delivered, avoiding premature solution commitment",
    ...
    },
    {
        ...
        "options": [
            "A business requirement became a transition requirement",
            "A vague stakeholder need was refined into a measurable non-functional solution requirement",
            "A stakeholder requirement was elevated to a business requirement",
            "A functional requirement was rewritten as a design constraint"
        ],
        "answer": "A vague stakeholder need was refined into a measurable non-functional solution requirement",
    ...
    },
    {
        ...
        "options": [
            ...
            "Business Analysis Planning and Monitoring, and Strategy Analysis",
        ...
        "answer": "Elicitation and Collaboration, and Requirements Life Cycle Management",
    ...
    },
    {
        ...
        "options": [
            "Between stakeholder requirements and transition requirements",
            "Between solution requirements and design",
            "Between stakeholder requirements and business requirements",
            "Between functional and non-functional requirements"
        ],
        "answer": "Between stakeholder requirements and business requirements",
    ...
    },
    {
        ...
        "options": [
            "Re-elicit all requirements from scratch",
            "Update the traceability matrix",
            "Conduct solution evaluation to assess whether the solution delivers expected value and identify root causes",
            "Escalate to the project sponsor for a new project"
        ],
        "answer": "Conduct solution evaluation to assess whether the solution delivers expected value and identify root causes",
    ...
    },
    {
        ...
        "options": [
            "The BA's authority supersedes the sponsor's",
            "BABOK® v3 mandates validation regardless of governance",
            "Validation ensures requirements will lead to a solution delivering intended value; sign-off confirms approval, not correctness",
            "Validation is required for compliance"
        ],
        "answer": "Validation ensures requirements will lead to a solution delivering intended value; sign-off confirms approval, not correctness",
    ...
    },
    {
        ...
        "options": [
            "BABOK® v3 describes generally accepted BA practices that practitioners tailor based on context",
            "BABOK® v3 provides a prescriptive process that must be followed exactly",
            "BABOK® v3 replaces all organizational BA methodologies",
            "BABOK® v3 only applies to CBAP® candidates"
        ],
        "answer": "BABOK® v3 describes generally accepted BA practices that practitioners tailor based on context",
    ...
    },
    {
        ...
        "options": [
            "Too few requirements were produced",
            "Requirements were approved but not aligned with the true Need and expected Value",
            "The BA should have managed the project",
            "The developers did not follow the requirements"
        ],
        "answer": "Requirements were approved but not aligned with the true Need and expected Value",
    ...
    },
    {
        ...
        "options": [
            "The project manager failed to deliver",
            "Testing was insufficient",
            "The Solution was not aligned with the actual Need, the expected Value was not defined correctly, or the Context changed during delivery",
            "Requirements were not detailed enough"
        ],
        "answer": "The Solution was not aligned with the actual Need, the expected Value was not defined correctly, or the Context changed during delivery",
    ...
    },
    {
        ...
        "options": [
            "The BACCM is a process model for BA activities",
            "The BACCM is only used in planning phases",
            "The BACCM replaces the Knowledge Areas",
            "The BACCM provides a universal conceptual framework applicable to all BA tasks"
        ],
        "answer": "The BACCM provides a universal conceptual framework applicable to all BA tasks",
    ...
    },
    {
        ...
        "options": [
            "BA reduces PM workload",
            "BA ensures we solve the right problem before investing in a solution; PM ensures the chosen solution is delivered within constraints—both are essential and complementary",
            "BA replaces PM in agile projects",
            "BA is only needed for large projects"
        ],
        "answer": "BA ensures we solve the right problem before investing in a solution; PM ensures the chosen solution is delivered within constraints—both are essential and complementary",
    ...
    },
    {
        ...
        "options": [
            "Accept the PM's declaration to avoid conflict",
            "Escalate directly to the executive sponsor",
            "Present evidence of elicitation gaps and explain the risk of proceeding with incomplete requirements",
            "Proceed silently and document concerns privately"
        ],
        "answer": "Present evidence of elicitation gaps and explain the risk of proceeding with incomplete requirements",
    ...
    },
    {
        ...
        "options": [
            "To provide a checklist of BA tasks",
            "To replace the Knowledge Areas for simpler initiatives",
            "To provide a common vocabulary and conceptual framework that helps all team members understand BA work consistently",
            "To certify BA competency"
        ],
        "answer": "To provide a common vocabulary and conceptual framework that helps all team members understand BA work consistently",
    ...
    },
    {
        ...
        "options": [
            "Practice—it implies structured discipline",
            "Change—it means BA is only relevant when something is being transformed",
            "Enabling—it means BA facilitates and supports rather than directs",
            "Both A and C are equally significant"
        ],
        "answer": "Change—it means BA is only relevant when something is being transformed",
    ...
    },
    {
        ...
        "options": [
            "IT delivery is independent of BA quality",
            "Without BA rigorously defining and validating needs, technical solutions satisfy specifications rather than actual stakeholder value",
            "Business user satisfaction is a PM responsibility",
            "This is a training problem, not a BA problem"
        ],
        "answer": "Without BA rigorously defining and validating needs, technical solutions satisfy specifications rather than actual stakeholder value",
    ...
    },
    {
        ...
        "options": [
            "A process violation—planning must always precede elicitation",
            "Only allowed in agile projects",
            "Acceptable—BABOK® v3 KAs can be executed iteratively and in any order based on context",
            "Unacceptable regardless of context"
        ],
        "answer": "Acceptable—BABOK® v3 KAs can be executed iteratively and in any order based on context",
    ...
    },
    {
        ...
        "options": [
            "Current-state analysis, future-state definition, and the change strategy that guide elicitation, RADD, and RLCM",
            "A requirements document and a stakeholder register",
            "A project charter and business case",
            "A risk register and issue log"
        ],
        "answer": "Current-state analysis, future-state definition, and the change strategy that guide elicitation, RADD, and RLCM",
    ...
    },
    {
        ...
        "options": [
            "That BA planning is done in isolation",
            "That BA planning is a one-time activity",
            "That BA planning must wait for full requirements",
            "That KAs are interconnected—Strategy Analysis outputs serve as inputs to BA Planning and Monitoring"
        ],
        "answer": "That KAs are interconnected—Strategy Analysis outputs serve as inputs to BA Planning and Monitoring",
    ...
    },
    {
        ...
        "options": [
            "A common vocabulary and conceptual foundation for all business analysis work",
            "A step-by-step process for performing BA",
            "A certification framework for BAs",
            "A measurement system for BA performance"
        ],
        "answer": "A common vocabulary and conceptual foundation for all business analysis work",
    ...
    },
    {
        ...
        "options": [
            "It is a BABOK® v3 rule that must be followed",
            "Examining all six protects the BA from criticism",
            "Each concept represents a dimension of understanding necessary to ensure the change delivers genuine value; missing any one creates blind spots",
            "Only three concepts are relevant per initiative but all six must be documented"
        ],
        "answer": "Each concept represents a dimension of understanding necessary to ensure the change delivers genuine value; missing any one creates blind spots",
    ...
    },
    {
        ...
        "options": [
            ...
            "To slow down the development team",
            "To ensure all solution requirements have legitimate justification and link to the actual needs driving the initiative",
            "To satisfy audit requirements"
        ],
        "answer": "To ensure all solution requirements have legitimate justification and link to the actual needs driving the initiative",
    ...
    },
    {
        ...
        "options": [
            ...
            "The BA's performance review will be negative",
            "Key requirements from unidentified stakeholders may be missed, discovered late and at greater cost",
            "The sponsor will lose confidence"
        ],
        "answer": "Key requirements from unidentified stakeholders may be missed, discovered late and at greater cost",
    ...
    },
    {
        ...
        "options": [
            "BA tasks must be performed in a fixed sequence beginning with requirements",
            "Only the sponsor needs to be identified at project start",
            "Stakeholder analysis is a PM responsibility",
            "Thorough stakeholder identification early is foundational—missed stakeholders lead to missed needs and failed solutions"
        ],
        "answer": "Thorough stakeholder identification early is foundational—missed stakeholders lead to missed needs and failed solutions",
    ...
    },
    {
        ...
        "options": [
            "Nothing—combining them improves efficiency",
            "Confusing stakeholders about the technology",
            "Violating BABOK® v3 documentation standards",
            "Blurring the boundary between requirements and designs, potentially constraining solution options unnecessarily"
        ],
        "answer": "Blurring the boundary between requirements and designs, potentially constraining solution options unnecessarily",
    ...
    },
    {
        ...
        "options": [
            "The difference between BA and project management",
            "The BACCM in action",
            "Traceability—the RLCM mechanism ensuring every solution element links to a justified need",
            "The sequential nature of Knowledge Areas"
        ],
        "answer": "Traceability—the RLCM mechanism ensuring every solution element links to a justified need",
    ...
    },
    {
        ...
        "options": [
            "Nothing—BABOK® v3 is intended to be sequential",
            "The sequential interpretation only fails for agile projects",
            "Only Strategy Analysis must come first; the rest can be sequential",
            "BABOK® v3 Knowledge Areas are not sequential phases; they are groups of related tasks that can be performed in any order, iteratively, based on context"
        ],
        "answer": "BABOK® v3 Knowledge Areas are not sequential phases; they are groups of related tasks that can be performed in any order, iteratively, based on context",
    ...
    },
    {
        ...
        "options": [
            "Need and Context (BACCM) have shifted; Strategy Analysis (re-examine need/future state) and Solution Evaluation (assess current performance) are both relevant",
            "Only Solution Evaluation",
            "Only Requirements Life Cycle Management",
            "BACCM is not relevant to post-deployment assessments"
        ],
        "answer": "Need and Context (BACCM) have shifted; Strategy Analysis (re-examine need/future state) and Solution Evaluation (assess current performance) are both relevant",
    ...
    },
    {
        ...
        "options": [
            "Value—demonstrating the expected worth and benefit relative to the investment",
            "Solution—describing what will be built",
            "Change—describing what will transform",
            "Context—describing the current environment"
        ],
        "answer": "Value—demonstrating the expected worth and benefit relative to the investment",
    ...
    },
    {
        ...
        "options": [
            "The transformation will take too long",
            "There will be no shared basis for measuring success or making trade-off decisions, increasing the likelihood of failed outcomes",
            "Developers will not know what to build",
            "The project manager will lose control"
        ],
        "answer": "There will be no shared basis for measuring success or making trade-off decisions, increasing the likelihood of failed outcomes",
    ...
    },
    {
        ...
        "options": [
            "Yes—only certified BAs may perform tasks described in BABOK® v3",
            "Yes—regulations require certification for all BA activities",
            "No—CBAP® certifies knowledge but BABOK® v3 defines BA by the tasks performed, not certification status",
            "Only in financial services sectors is certification mandatory"
        ],
        "answer": "No—CBAP® certifies knowledge but BABOK® v3 defines BA by the tasks performed, not certification status",
    ...
    },
    {
        ...
        "options": [
            "The BACCM organizes tasks; KAs organize concepts",
            "The BACCM provides a conceptual vocabulary; KAs organize the tasks and practices BAs perform",
            "The BACCM applies only to strategic work; KAs apply to tactical work",
            "They are identical—KAs are just a renamed version of the BACCM"
        ],
        "answer": "The BACCM provides a conceptual vocabulary; KAs organize the tasks and practices BAs perform",
    ...
    },
    {
        ...
        "options": [
            "The BACCM as a documentation checklist",
            "The BACCM as a replacement for practical techniques",
            "The BACCM as the conceptual foundation for all BA thinking and practice",
            "The BACCM as a methodology for large programs only"
        ],
        "answer": "The BACCM as the conceptual foundation for all BA thinking and practice",
    ...
    },
    {
        ...
        "options": [
            "The BA function is too large and creates bureaucratic overhead",
            "Requirements documentation is too detailed",
            "The BA team uses too many elicitation techniques",
            "BA tasks are performed rigorously but Solution Evaluation is absent—solutions are delivered and forgotten without measuring whether expected value was achieved"
        ],
        "answer": "BA tasks are performed rigorously but Solution Evaluation is absent—solutions are delivered and forgotten without measuring whether expected value was achieved",
    ...
    },
    {
        ...
        "options": [
            "Agree—PI Planning fully covers Strategy Analysis tasks",
            "PI Planning is a planning ceremony; Strategy Analysis is the intellectual discipline of understanding current state, defining future state, and identifying the change strategy—these are complementary, not substitutes",
            "BABOK® v3 does not apply to SAFe® environments",
            "Strategy Analysis only applies to waterfall and is not relevant in SAFe®"
        ],
        "answer": "PI Planning is a planning ceremony; Strategy Analysis is the intellectual discipline of understanding current state, defining future state, and identifying the change strategy—these are complementary, not substitutes",
    ...
    },
    {
        ...
        "options": [
            "Verification checks that requirements are well-written; validation checks that stakeholders approved them",
            "Validation is only needed when regulatory compliance is involved",
            "Both are the same activity performed at different times",
            "Verification ensures requirements are internally consistent and complete; validation ensures they will lead to a solution that delivers the intended business value—sign-off confirms agreement, not correctness or fitness for purpose"
        ],
        "answer": "Verification ensures requirements are internally consistent and complete; validation ensures they will lead to a solution that delivers the intended business value—sign-off confirms agreement, not correctness or fitness for purpose",
    ...
    },
    {
        ...
        "options": [
            "RADD writes requirements; RLCM approves them",
            "RADD is performed before RLCM in all methodologies",
            "RADD applies only to functional requirements; RLCM applies to non-functional requirements",
            "RADD transforms elicited information into specified, modeled, verified, and validated requirements and solution designs; RLCM governs the lifecycle of those artifacts—tracing, prioritizing, controlling changes, and maintaining their integrity over time"
        ],
        "answer": "RADD transforms elicited information into specified, modeled, verified, and validated requirements and solution designs; RLCM governs the lifecycle of those artifacts—tracing, prioritizing, controlling changes, and maintaining their integrity over time",
    ...
    },
    {
        ...
        "options": [
            "Elicitation and Collaboration—elicitation was insufficient",
            "Business Analysis Planning and Monitoring—the BA plan was inadequate",
            "Solution Evaluation—the solution was not assessed before delivery",
            "Requirements Life Cycle Management—approved requirements were not maintained, traced, or governed through implementation"
        ],
        "answer": "Requirements Life Cycle Management—approved requirements were not maintained, traced, or governed through implementation",
    ...
    },
    {
        ...
        "options": [
            "Elicitation and Collaboration + RADD",
            "Strategy Analysis (continuous current/future state reassessment) + RLCM (requirements baseline updates reflecting strategic changes)",
            "BA Planning and Monitoring + Solution Evaluation",
            "RADD + Solution Evaluation"
        ],
        "answer": "Strategy Analysis (continuous current/future state reassessment) + RLCM (requirements baseline updates reflecting strategic changes)",
    ...
    },
    {
        ...
        "options": [
            "Agree—the BACCM is primarily for academic purposes",
            "Cost/deliverable/timeline maps to Context (constraints), Solution (deliverable), and Change (transformation)—but without explicitly examining Need, Value, and Stakeholder, organizations routinely build the right thing for the wrong people, at the right cost for the wrong outcomes. The BACCM prevents these expensive blind spots",
            "The board only needs to understand Value and Cost",
            "The BACCM is only relevant for BA practitioners, not executives"
        ],
        "answer": "Cost/deliverable/timeline maps to Context (constraints), Solution (deliverable), and Change (transformation)—but without explicitly examining Need, Value, and Stakeholder, organizations routinely build the right thing for the wrong people, at the right cost for the wrong outcomes. The BACCM prevents these expensive blind spots",
    ...
    },
    {
        ...
        "options": [
            "Risk can manifest as both Context (environmental uncertainty affecting the change) and Need (a threat that must be addressed)—the BACCM's six concepts are sufficient to represent risk through existing relationships without requiring a seventh concept",
            "Risk is a separate concept that BABOK® v3 accidentally excluded",
            "Risk only belongs in Context",
            "Risk is exclusively a PM concern and has no place in the BACCM"
        ],
        "answer": "Risk can manifest as both Context (environmental uncertainty affecting the change) and Need (a threat that must be addressed)—the BACCM's six concepts are sufficient to represent risk through existing relationships without requiring a seventh concept",
    ...
    },
    {
        ...
        "options": [
            "Need was incorrectly defined → Solution was built to the wrong Need → key Stakeholders were excluded → Context shift was not monitored—a cascading failure across multiple BACCM concepts",
            "Context–Solution mismatch only",
            "Stakeholder exclusion was the only failure",
            "The merger (Context) was the sole root cause"
        ],
        "answer": "Need was incorrectly defined → Solution was built to the wrong Need → key Stakeholders were excluded → Context shift was not monitored—a cascading failure across multiple BACCM concepts",
    ...
    },
    {
        ...
        "options": [
            "Sprint artifacts name these concepts but do not guarantee rigorous analysis of them. The BACCM ensures that Need, Value, Context, and Stakeholder are analytically examined—not just named. Sprint goals can be wrong needs; Definition of Done can measure delivery, not value",
            "Agree—the sprint framework replaces the BACCM",
            "The BACCM only applies to large programs, not sprints",
            "Sprint ceremonies are sufficient if the Product Owner is experienced"
        ],
        "answer": "Sprint artifacts name these concepts but do not guarantee rigorous analysis of them. The BACCM ensures that Need, Value, Context, and Stakeholder are analytically examined—not just named. Sprint goals can be wrong needs; Definition of Done can measure delivery, not value",
    ...
    },
    {
        ...
        "options": [
            "They are not hierarchical—they are independent categories",
            "Solution requirements are most important; Business requirements are least important",
            "Business requirements establish organizational intent; Stakeholder requirements translate that intent into specific group needs; Solution requirements define how the solution satisfies those needs; Transition requirements address temporary needs for reaching the future state—each layer traces to and must support the layer above",
            "The hierarchy only applies to waterfall methodologies"
        ],
        "answer": "Business requirements establish organizational intent; Stakeholder requirements translate that intent into specific group needs; Solution requirements define how the solution satisfies those needs; Transition requirements address temporary needs for reaching the future state—each layer traces to and must support the layer above",
    ...
    },
    {
        ...
        "options": [
            "It is purely a business requirement",
            "It is a transition requirement because it relates to a new process",
            "It is non-functional because it relates to compliance",
            "It is a functional solution requirement (a specific system behavior); it may also reflect a business requirement if the underlying driver is regulatory compliance—in which case the functional requirement must be traceable to that business requirement"
        ],
        "answer": "It is a functional solution requirement (a specific system behavior); it may also reflect a business requirement if the underlying driver is regulatory compliance—in which case the functional requirement must be traceable to that business requirement",
    ...
    },
    {
        ...
        "options": [
            "The reconciliation process was misclassified—if the process persists post-transition, it is a permanent operational process that should have been captured as a functional or stakeholder requirement, not a transition requirement",
            "The transition requirement was correctly retired",
            "Transition requirements should never be retired",
            "This is a project management gap, not a BA gap"
        ],
        "answer": "The reconciliation process was misclassified—if the process persists post-transition, it is a permanent operational process that should have been captured as a functional or stakeholder requirement, not a transition requirement",
    ...
    },
    {
        ...
        "options": [
            "Reduce the stakeholder list to the top 10 by seniority",
            "Engage only stakeholders who attend project meetings",
            "Delegate all stakeholder engagement to the project manager",
            "Apply stakeholder analysis (influence, impact, attitude, availability) to define differentiated engagement strategies—high-influence/high-impact groups receive intensive engagement; others receive appropriate communication—ensuring all are accounted for without equal resource allocation"
        ],
        "answer": "Apply stakeholder analysis (influence, impact, attitude, availability) to define differentiated engagement strategies—high-influence/high-impact groups receive intensive engagement; others receive appropriate communication—ensuring all are accounted for without equal resource allocation",
    ...
    },
    {
        ...
        "options": [
            "Immediately update the stakeholder register, conduct analysis of the new body's requirements and influence, assess impact on existing requirements, and present findings to the sponsor for scope and risk review",
            "Continue with the existing plan—the new body was not in the original scope",
            "Let the legal team handle it",
            "Wait until go-live to assess the regulatory body's requirements"
        ],
        "answer": "Immediately update the stakeholder register, conduct analysis of the new body's requirements and influence, assess impact on existing requirements, and present findings to the sponsor for scope and risk review",
    ...
    },
    {
        ...
        "options": [
            "The boundary is defined by abstraction level and intent: requirements describe what is needed and why (solution-agnostic); designs describe how a specific solution will be structured. A single artifact can cross this boundary depending on the level of implementation detail it contains",
            "When it is approved by the project sponsor",
            "Designs are always created by architects; requirements by BAs",
            "When the document is passed from BA to developer"
        ],
        "answer": "The boundary is defined by abstraction level and intent: requirements describe what is needed and why (solution-agnostic); designs describe how a specific solution will be structured. A single artifact can cross this boundary depending on the level of implementation detail it contains",
    ...
    },
    {
        ...
        "options": [
            "The development team made implementation errors",
            "The process model was a requirements artifact (what the process must do) used as a design specification (how to build it)—collapsing the requirements-design boundary caused the solution to satisfy the model rather than the underlying business Need and expected Value",
            "The BA did not produce enough documentation",
            "The project manager failed to control scope"
        ],
        "answer": "The process model was a requirements artifact (what the process must do) used as a design specification (how to build it)—collapsing the requirements-design boundary caused the solution to satisfy the model rather than the underlying business Need and expected Value",
    ...
    },
    {
        ...
        "options": [
            "Only Solution Evaluation was skipped",
            "Multiple possibilities: (1) Need was incorrectly defined despite thorough analysis; (2) Value was never explicitly defined so success was unmeasurable; (3) Context shifted post-delivery and was not monitored; (4) Solution Evaluation was not performed to detect and respond to underperformance",
            "The PM failed to manage benefits realization",
            "Requirements were not detailed enough"
        ],
        "answer": "Multiple possibilities: (1) Need was incorrectly defined despite thorough analysis; (2) Value was never explicitly defined so success was unmeasurable; (3) Context shifted post-delivery and was not monitored; (4) Solution Evaluation was not performed to detect and respond to underperformance",
    ...
    },
    {
        ...
        "options": [
            "Start with RADD to produce requirements templates",
            "First establish BA Planning and Monitoring (how BA will work); concurrently activate Strategy Analysis (understand organizational needs); then build Elicitation, RLCM, and RADD capabilities; finally implement Solution Evaluation to close the value loop",
            "Start with Solution Evaluation to assess current solution quality",
            "Start with stakeholder identification and stop there until all stakeholders are fully mapped"
        ],
        "answer": "First establish BA Planning and Monitoring (how BA will work); concurrently activate Strategy Analysis (understand organizational needs); then build Elicitation, RLCM, and RADD capabilities; finally implement Solution Evaluation to close the value loop",
    ...
    },
    {
        ...
        "options": [
            "There is no single most important relationship—the BACCM requires holistic analysis; however, Value–Stakeholder is strategically critical here because unresolved Value conflicts across stakeholder groups will undermine the initiative regardless of execution quality",
            "Change–Context: managing the transition within union constraints",
            "Solution–Need: ensuring the vendor delivers cost reduction",
            "Need–Context: ensuring the cost reduction target is realistic"
        ],
        "answer": "There is no single most important relationship—the BACCM requires holistic analysis; however, Value–Stakeholder is strategically critical here because unresolved Value conflicts across stakeholder groups will undermine the initiative regardless of execution quality",
    ...
    },
    {
        ...
        "options": [
            "Document functional requirements for the new HR system",
            "Run a gap analysis between current and future HR system features",
            "Build a requirements document and present to the sponsor",
            "Examine: (1) Need—is 'improve employee experience' the real need or a symptom of something deeper? (2) Context—what regulatory, cultural, and technical constraints apply? (3) Stakeholders—who defines 'employee experience' and are all affected groups identified? (4) Value—how will improvement be measured and by whom? (5) Change—what transformation is required? (6) Solution—has replacing the legacy system been validated against the actual Need, or is it a pre-defined solution masquerading as a requirement?"
        ],
        "answer": "Examine: (1) Need—is 'improve employee experience' the real need or a symptom of something deeper? (2) Context—what regulatory, cultural, and technical constraints apply? (3) Stakeholders—who defines 'employee experience' and are all affected groups identified? (4) Value—how will improvement be measured and by whom? (5) Change—what transformation is required? (6) Solution—has replacing the legacy system been validated against the actual Need, or is it a pre-defined solution masquerading as a requirement?",
        ...
        if wrong:
            ...
            with st.expander(f"📖  Review {len(wrong)} incorrect answer(s)"):
                for _, (i, q) in enumerate(wrong):
                    ...
                    letters  = ["A", "B", "C", "D"]
                    correct  = q["answer"]
                    correct_letter = letters[q["options"].index(correct)] if correct in q["options"] else "?"
                    user_letter    = letters[q["options"].index(user_ans)] if user_ans in q["options"] else "?"
                    st.markdown(f"""
                    <div style='margin-bottom:1.2rem;padding:1rem;background:rgba(155,35,53,0.12);
                        ...
                        <div style='color:#f4a0a0'>❌ Your answer: {user_letter}) {user_ans}</div>
                        <div style='color:#6fe4a4'>✅ Correct: {correct_letter}) {correct}</div>
    ...
    if not already_submitted:
        ...
        if is_correct:
            ...
            <div class="feedback-wrong">
                ❌ <b>Incorrect.</b> Correct answer: <b>{correct_letter}) {correct_ans}</b>
                <div class="feedback-explanation">💡 {q["explanation"]}</div>
            </div>""", unsafe_allow_html=True)
